...
<p align="center">
  <img src="docs/screenshots/main_screen.png" width="23.5%" alt="NetMuzzle Main Dashboard" />
  <img src="docs/screenshots/configured_apps.png" width="23.5%" alt="Configured 3-State Capsules" />
  <img src="docs/screenshots/filtered_game.png" width="23.5%" alt="Active Game Shield" />
  <img src="docs/screenshots/game_ads_options.png" width="23.5%" alt="Game AdBlock Filters" />
</p>

<p align="center">
  <em>From left to right: <strong>(1)</strong> Main Dashboard with 4-way filter chips, <strong>(2)</strong> 3-State action capsules with glowing outlines, <strong>(3)</strong> Isolated view of shielded games, <strong>(4)</strong> Granular ad network toggles for rewarded ads.</em>
</p>
...
* Automatically detects your device language and displays native English or Polish with an in-app language switcher dialog.
